...
- CDN从Database中查询session_id+can_method+resource_id -> locally|remotely|null的映射，这一步可以细分为三步：
  - CDN从Database中查询session_id -> user_groups的映射。
  - CDN从Database中查询resource_id -> resource_groups的映射。
  - CDN从Database中查询user_groups+can_method+resource_groups -> locally|remotely|null 的映射。
...
- user_groups+can_method+resource_groups -> locally|remotely|null
